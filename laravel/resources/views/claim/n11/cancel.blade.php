...
@section('title', 'İptal - N11')

@section('url', '/n11/iptal')
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel">İptal</h5>
...
<script>
    ...
    @if (isset($datas->pagingData->pageCount) && $datas->pagingData->pageCount > 1)
        ...
        @elseif ($page > $datas->pagingData->pageCount)
            location.href = '/iadeler/n11/iptal?page={{ $datas->pagingData->pageCount - 1 }}&date={{ $date[0] }} | {{ $date[1] }}';
        @endif
