...
var _createClass = function() {
  ...
  , Dropzone = function(a) {
    function b(a, c) {
        ...
        if (null == d.options.url && (d.options.url = d.element.getAttribute("action")),
        !d.options.url)
        ...
        return d.options.acceptedMimeTypes && (d.options.acceptedFiles = d.options.acceptedMimeTypes,
        ...
        value: function() {
            ...
            this.prototype.defaultOptions = {
                ...
                fallback: function() {
                    ...
                    a || (a = b.createElement('<div class="dz-message"><span></span></div>'),
                ...
                resize: function(a, b, c, d) {
                    var e = {
                      ...
                      , f = a.width / a.height;
                    null == b && null == c ? (b = e.srcWidth,
                    c = e.srcHeight) : null == b ? b = c * f : null == c && (c = b / f),
                    b = Math.min(b, e.srcWidth),
                    c = Math.min(c, e.srcHeight);
                    var g = b / c;
                    if (e.srcWidth > b || e.srcHeight > c)
                        if ("crop" === d)
                            f > g ? (e.srcHeight = a.height,
                            e.srcWidth = e.srcHeight * g) : (e.srcWidth = a.width,
                ...
                addedfile: function(a) {
                    ...
                    this.previewsContainer) {
                        ...
                        this.options.addRemoveLinks && (a._removeLink = b.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>"),
                ...
                complete: function(a) {
                    if (a._removeLink && (a._removeLink.innerHTML = this.options.dictRemoveFile),
                    a.previewElement)
    ...
    _createClass(b, [{
        ...
        value: function() {
            ...
            return "FORM" !== this.element.tagName ? (c = b.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>'),
            c.appendChild(e)) : (this.element.setAttribute("enctype", "multipart/form-data"),
        ...
        value: function(a) {
            ...
            this.accept(a, function(b) {
                ...
                c._errorProcessing([a], b)) : (a.accepted = !0,
        ...
        value: function(a) {
            if (a.status === b.UPLOADING) {
                ...
                a.status !== b.ADDED && a.status !== b.QUEUED || (a.status = b.CANCELED,
                ...
                for (var b = this.element.querySelectorAll("input, textarea, select, button"), c = 0, b = b; ; ) {
                    ...
                    void 0 !== f && null !== f)
                        if ("SELECT" === e.tagName && e.hasAttribute("multiple"))
                            ...
                            (!g || "checkbox" !== g && "radio" !== g || e.checked) && a.append(f, e.value)
                }
        }
    }, {
        ...
        value: function(a, b, c) {
            ...
            if (void 0 !== c) {
                ...
                a[0].upload.chunked) {
                    ...
                    for (var g = 0; g < e.upload.totalChunkCount; g++)
                        void 0 !== e.upload.chunks[g] && void 0 !== e.upload.chunks[g].progress && (e.upload.progress += e.upload.chunks[g].progress,
        ...
        value: function(a, c, d) {
            ...
            if (a[0].status !== b.CANCELED && 4 === c.readyState) {
                if ("arraybuffer" !== c.responseType && "blob" !== c.responseType && (e = c.responseText,
                c.getResponseHeader("content-type") && ~c.getResponseHeader("content-type").indexOf("application/json")))
                    try {
                        e = JSON.parse(e)
                    } catch (a) {
                        d = a,
        ...
        value: function(a, c, d) {
            ...
            if (this.options.uploadMultiple && (this.emit("successmultiple", a, c, d),
...
Dropzone.isValidFile = function(a, b) {
    ...
    for (var c = a.type, d = c.replace(/\/.*$/, ""), e = b, f = 0, e = e; ; ) {
        ...
        if (h = h.trim(),
        "." === h.charAt(0)) {
            if (-1 !== a.name.toLowerCase().indexOf(h.toLowerCase(), a.name.length - h.length))
                return !0
        } else if (/\/\*$/.test(h)) {
            if (d === h.replace(/\/.*$/, ""))
                return !0
